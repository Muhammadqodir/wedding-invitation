...
<head>
  ...
  <!-- Descriptions -->
  <meta content="Bahtli onimizda biz uchun qalbingizdagi eng yahshi tilaklaringiz bilan yonimizda bolishingizni soraymiz." name="description">
  <meta content="Bahtli onimizda biz uchun qalbingizdagi eng yahshi tilaklaringiz bilan yonimizda bolishingizni soraymiz." itemprop="description">
  <meta content="Bahtli onimizda biz uchun qalbingizdagi eng yahshi tilaklaringiz bilan yonimizda bolishingizni soraymiz." name="twitter:description">
  <meta content="Bahtli onimizda biz uchun qalbingizdagi eng yahshi tilaklaringiz bilan yonimizda bolishingizni soraymiz." property="og:description">
...
<body>
  ...
  <figure class="date" style="text-align: center; margin-top: 0px !important; margin-bottom: 0px !important;">
    ...
    <p class="optional" style="font-weight: bold; font-family: Campton; font-size: 25px; max-width: 500px; margin: auto;">
      Xurmatli sinifdoshlar!
    </p>
    <p class="optional" style="font-family: Campton; font-size: 25px; max-width: 500px; margin: auto;">
      Bahtli onimizda biz uchun qalbingizdagi eng yahshi tilaklaringiz bilan yonimizda bolishingizni
      so'raymiz.
    </p><br>
